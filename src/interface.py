...
frame_2_button = customtkinter.CTkButton(navigation_frame, corner_radius=0, height=40, border_spacing=10, text="GAME FRAME",
                                         fg_color="transparent", text_color=("gray10", "gray90"), hover_color=("gray70", "gray30"),
                                         image=chat_image, anchor="w", command=frame_2_button_event)
frame_2_button.grid(row=2, column=0, sticky="ew")

frame_3_button = customtkinter.CTkButton(navigation_frame, corner_radius=0, height=40, border_spacing=10, text="END MENU",
                                         fg_color="transparent", text_color=("gray10", "gray90"), hover_color=("gray70", "gray30"),
...
home_frame_button_2 = customtkinter.CTkButton(home_frame, text="CTkButton", image=image_icon_image, compound="right")
home_frame_button_2.grid(row=2, column=0, padx=20, pady=10)
home_frame_button_3 = customtkinter.CTkButton(home_frame, text="CTkButton", image=image_icon_image, compound="top")
home_frame_button_3.grid(row=3, column=0, padx=20, pady=10)
home_frame_button_4 = customtkinter.CTkButton(home_frame, text="CTkButton", image=image_icon_image, compound="bottom", anchor="w")
